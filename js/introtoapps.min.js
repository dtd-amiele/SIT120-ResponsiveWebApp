(function () {
    var d, S = [].indexOf || function (d) {
        for (var p = 0, x = this.length; p < x; p++)
            if (p in this && this[p] === d) return p;
        return -1
    };
    ...
    Array.prototype.contains = function (d) {
        var p;
        for (p = this.length; p--;)
            if (this[p] === d) return !0;
        return !1
    };
    Array.prototype.removeIndex = function (d) {
        return this.splice(d, 1)
    };
    window.random = function (d, p) {
        return null != p ? Math.round(Math.random() * (p - d)) + d : Math.round(Math.random() * d)
    };
    window[d] = d = {
        debuggingOn: !1,
        movingObjects: {},
        ...
        paused: !1,
        init: function () {
            var w, p, x, D, E, F, A, y, G, q, z, H, I, J, K, L, M, B, N, O, P, Q, C, u, r, R, k;
            ...
            z = function (b, a) {
                ...
                h = a.w;
                e = v + a.h;
                return s !== m || f < v || t > e || d + g < n || d > n + h ? !1 : !0
            };
            q = function (b) {
                var a;
                a = b.data("iid");
                null == a && (a = d.nextID++, b.data("iid", a));
                return null != d.movingObjects[a] ?
                    d.movingObjects[a] : {
                        id: a,
                        obj: b,
                        init: !1,
            ...
            p = function () {
                var b, a, f, e, g, h, l, n, t, v, s, m, c;
                if (d.animate)
                    if (d.paused) d.lastUpdate = (new Date).getTime(), requestAnimFrame(p);
                    else {
                        if ((new Date).getTime() > d.lastUpdate + 16) {
                            ...
                            for (n in h)
                                if (c = h[n], !c.init)
                                    for (f in c.init = !0, l = d.movingObjects, l) e = l[f], f !== n && ((null != c.onCollision || null != e.onCollision || c.autoBounceBack || e.autoBounceBack || c.autoBounceOff || e.autoBounceOff) && !e.collisions.contains(c.id) && !c.collisions.contains(e.id) && z(c, e)) && (c.collisions.push(e.id), e.collisions.push(c.id));
                            e = d.movingObjects;
                            for (n in e) {
                                c = e[n];
                                ...
                                null != c.weight && 0 < c.weight ? (h = c.obj.closest(".scene"), h = 0 < h.length && null != h.data("iid") ? gravityObjects[null != h.data("iid")] : null, h = null != h && null != h.gravity && "number" === typeof h.gravity ? h.gravity : d.gravity, null == c.vy && (c.vy = 0), c.vy += h * c.weight, c.y += c.vy, c.obj.originalCssFunction("top", c.y + "px"), b = c.xMoveThisCycle, a = c.yMoveThisCycle + c.vy, c.actualAngle = Math.atan2(b, -a), 0 > c.actualAngle && (c.actualAngle += 2 * Math.PI), d.movingObjects[n] = c, t = !0) : null != c.weight && (0 === c.weight && 0 !== c.vy) && (c.vy = 0, d.movingObjects[n] =
                                    c);
                                if (t && ( null != c.onOffScreen) && (0 > c.x + c.w || 0 > c.y + c.h || c.x > g || c.y > m)) {
                                    c.autoRemoveOffScreen && (c.obj.originalRemoveFunction(), delete d.movingObjects[n]);
                                    try {
                            ...
                            s = d.movingObjects;
                            for (n in s)
                                for (f in c = s[n], m = d.movingObjects, m)
                                    if (e = m[f], f !== n) {
                                        if ((null != c.onCollision || null != e.onCollision || c.autoBounceBack || e.autoBounceBack || c.autoBounceOff || e.autoBounceOff) && !e.collisions.contains(c.id) && !c.collisions.contains(e.id) && z(c, e)) {
                                            c.collisions.push(e.id);
                                            e.collisions.push(c.id);
                                            if (null != c.onCollision) try {
                                                c.obj.onCollision = c.onCollision, c.obj.onCollision(e.obj)
                                            } catch (q) {
                                                g = q, console.log(g)
                                            }
                                            if (null != e.onCollision) try {
                                                e.obj.onCollision = e.onCollision, e.obj.onCollision(c.obj)
                                            } catch (r) { }
                                            jQuery.contains(document, c.obj[0]) && jQuery.contains(document, e.obj[0]) && (c.autoBounceBack ? c.obj.bounceBack(e.obj) : c.autoBounceOff && c.obj.bounceOff(e.obj), e.autoBounceBack ? e.obj.bounceBack(c.obj) : e.autoBounceOff && e.obj.bounceOff(c.obj))
                                        }
                                        g = l = 0;
                                        for (t = c.collisions.length; 0 <=
                                            t ? l < t : l > t; g = 0 <= t ? ++l : --l) h = c.collisions[g], e = d.movingObjects[h], d.movingObjects.hasOwnProperty(h) && jQuery.contains(document, e.obj[0]) && z(c, e) || c.collisions.removeIndex(g)
                                    }
                            d.lastUpdate = (new Date).getTime()
                        }
                        return requestAnimFrame(p)
                    }
            };
            r = function () {
                if (!d.animate) return d.animate = !0, u(), requestAnimFrame(p)
            };
            u = function () {
                var b, a, f, e, g;
                if (d.animate) {
                    ...
                    g = d.movingObjects;
                    for (e in g) f = g[e], jQuery.contains(document, f.obj[0]) || delete d.movingObjects[f.id];
                    g = [];
                    e = 0;
                    for (f = b.length; e < f; e++) a = b[e], a = $(a), null == a.data("iid") ? (a = q(a), g.push(d.movingObjects[a.id] = a)) : g.push(void 0);
                    return g
                }
            };
                ...
                try {
                    return g = "start", (window.location.href.startsWith("http://localhost") || window.location.href.startsWith("localhost") || window.location.href.startsWith("file://")) && 0 > b.indexOf("://") || b.startsWith("http://localhost") || b.startsWith("localhost"), g = "ready", g = "pre ajax", $.ajax({
                        ...
                        success: function (f, g, d) {
                            var h;
                            try {
                                if (h = new Date(d.getResponseHeader("Last-Modified")),
                                    "function" === typeof a) return a(f, h)
                            } catch (l) {
                                if ("undefined" === typeof e || !0 === e) return errorLogOnly("get(" + b + ").followup", l.message)
                            }
                        },
                        error: function (a, e, g) {
                            if (!("string" === typeof g && 0 < g.length && 0 <= g.indexOf("Bad Gateway")) && (errorLogOnly("URL (" + b + "): " + e + " / " + g), "function" === typeof f)) return f("[" + e + "]: " + g)
                        }
                    }), g = "post ajax"
                } catch (d) {
                    try {
                        if ("undefined" === typeof e || !0 === e) return errorLogOnly("get", ui("errornocloud") + " () " + d.message + " (State: " + g + ")")
                    } catch (l) { }
                }
            };
            x = function (b, a) {
            ...
            R = function (b, a, f, e) {
                ...
                g = Math.abs(b - a);
                d = Math.abs(f - e);
                return g >= d ? 0 < b - a ? "Left" : "Right" : 0 < f - e ? "Up" : "Down"
            };
            F = function (b) {
                y = Clock.now();
                A = y - (k.last || y);
            ...
            (function (b) {
                ...
                b.fn.moveTo = function (a, f) {
                    ...
                    return this.each(function () {
                        ...
                        e = b(this);
                        e = q(e);
                        e.moveTo = null != f ? [a, f] : a;
                        e.xMoveThisCycle = 0;
                        e.yMoveThisCycle = 0;
                        return d.movingObjects[e.id] = e
                    })
                };
                b.fn.autoBounceBack =
                    function (a) {
                ...
                b.fn.bounceBack = function (a) {
                    d.animate || r();
                    d.debuggingOn && console.log("[" + this.attr("id") + "] Bouncing back from: " + a.attr("id"));
                    return this.each(function () {
                        var a, e;
                        e = q(b(this));
                        null != e.angle && (a = e.angle > Math.PI ?
                            e.angle - Math.PI : e.angle + Math.PI, e.moveTo = a * (180 / Math.PI));
                        return d.movingObjects[e.id] = e
                    })
                };
                b.fn.bounceOff = function (a) {
                    var f, e, g, h, l, n;
                    d.animate || r();
                    d.debuggingOn && console.log("[" + this.attr("id") + "] Bouncing off: " + a.attr("id"));
                    e = b(a);
                    l = e.offset().left;
                    n = e.offset().top;
                    g = e.outerHeight(!0);
                    ...
                    return this.each(function () {
                        var e, g, s, m, c, k, p, r;
                        c = q(b(this));
                        if (null != c.angle || null != c.actualAngle) s = c.obj, k = s.offset().left, g = s.offset().top, m = s.outerHeight(!0), s = s.outerWidth(!0),
                            e = g + m, p = k + s, m = null != c.actualAngle ? c.actualAngle : c.angle, m = s = m * (180 / Math.PI), 0 > m && (m += 360), 0 === m || 90 === m || 180 === m || 270 === m || 360 === m ? (m -= 180, 180 === s && (c.vy = 0)) : (r = Math.abs(e < n ? n - e : g - f), g = Math.abs(g > f ? g - f : n - e), e = Math.abs(p < l ? l - p : k - h), k = Math.abs(k > h ? k - h : l - p), Math.min(e, k) < Math.min(r, g) ? k = 0 : (k = 90, 90 < s && 270 > s && (c.vy = 0)), m = (2 * k - m) * (Math.PI / 180), k = 1 * Math.cos(m), m = 1 * Math.sin(m), m = 180 * Math.atan2(m, k) / Math.PI), 0 > m && (m += 360), c.moveTo = m, d.movingObjects[c.id] = c;
                        if (null == c.moveTo && null != a && (k = q(b(a)), null != k.angle)) return c.moveTo =
                            k.angle * (180 / Math.PI), d.movingObjects[c.id] = c
                    })
                };
                ...
                b.fn.autoRemoveOffScreen = function (a) {
                    d.animate || r();
                    d.debuggingOn && console.log("[" + this.attr("id") + "] Automatically removing from the screen");
                    return this.each(function () {
                        var f;
                        f = q(b(this));
                ...
                b.fn.weight = function (a) {
                    ...
                    return this.each(function () {
                        ...
                        f = b(this);
                        f = q(f);
                        return null != a ? (f.weight = a, d.movingObjects[f.id] = f, this) : null != (null != f ? f.weight : void 0)
                    })
                };
                b.fn.gravity = function (a) {
                    ...
                    return 0 === this.length ? d.gravity = a : this.each(function () {
                        ...
                        f = G(f);
                        f.gravity = a;
                        return d.gravityObjects[f.id] = f
                    })
                };
                ...
                b.fn.addChildren = function () {
                    ...
                    try {
                        ...
                        throw a = e, Error("addChildren() -> " + a.message);
                    }
                };
                        ...
                        if (!isArray(a) || a instanceof jQuery || "select" === this.ourType())
                            if ("function" === typeof a) this.onTap(a);
                                ...
                                if ("object" === typeof g.elementMap) {
                                    e = "object" === typeof a && "function" === typeof a.ourType ? a.ourType().toLowerCase() : typeof a;
                                    if ("function" === typeof g.elementMap[e]) return g.elementMap[e](this, a), this;
                                    if ("function" === typeof g.elementMap.other) return g.elementMap.other(this, a), this;
                                    if ("function" === typeof g.elementMap.object) return g.elementMap.object(this,
                                        a), this
                                }
                                "object" === typeof a ? b ? this.prepend(a) : this.append(a) : ("string" !== typeof a && (a = "" + a), g.text = g.text || [], g.text.push(a), this.append(uieval(a)))
                            }
                        else 0 < a.length && this.addChildren(a);
                        return this
                    } catch (d) {
                        throw Error("addChild(" + a + ") -> " + d.message);
                    }
                };
                ...
                b.fn.uiData = function (a, b) {
                    ...
                    try {
                        g = 1;
                        if ("object" !==
                            typeof this.uiObject) {
                            g = 2;
                            e = this.data("ui");
                            g = 3;
                            if ("object" !== typeof e && (e = {}, "object" !== typeof e && error("$.uiData()", "d not set"), this.data("ui", e), g = 4, "object" !== typeof this.data("ui"))) throw Error("this.data(ui) didn't save (jq length: " + this.length + " type:" + (0 < this.length ? this[0].tagName.toUpperCase() : "no jquery element") + " , " + this.data() + "). No jquery DOM element in your query?");
                            "object" !== typeof this.uiObject && (this.uiObject = e)
                        }
                        g = 5;
                        ...
                        throw Error("$.uiData(" + g + ") -> " + d.message);
                    }
                };
                ...
                b.fn.valid = function (a) {
                    var b, e;
                    try {
                        "undefined" !== typeof a && this.isType("textbox") && (b = this, e = div().attr("classname", "warning minibox-hidden"), this.addChild(e), this.children("input").on("input",
                            function (g) {
                                g = a(b, g);
                                if ("undefined" !== typeof g && null != g) return e.html(g), e.css("display", "block")
                            }))
                    } catch (g) {
                ...
                b.fn.onTap = function (a, f) {
                    ...
                    if (H) this.on("touchstart", function (a) {
                        ...
                        if ("function" === typeof functionCall && !("tap" !== D(window.event) || has(child.data("ui")) && has(child.data("ui").disabled))) return a(e,
                            b(this))
                    });
                    else this.on(w, function (e) {
                        e.preventDefault();
                        e.stopPropagation();
                        return a(e, b(this))
                    });
                ...
                b.fn.select = function (a, f) {
                    ...
                    try {
                        ...
                        if ("select" === this.ourType())
                            if (isNaN(l))
                                for (r = r.toLowerCase(), d = n = 0, m = this.children().length; 0 <= m ? n < m : n > m; d = 0 <= m ? ++n : --n) this.child(d).value().toLowerCase() === r ? (this.uiData().selected = d, this.child(d).prop("selected", !0)) : this.child(d).prop("selected", !1);
                            else this.attr("selectedIndex", l), this.uiData().selected = l, this.child(l).prop("selected", !0);
                        else if ("buttongroup" === this.ourType()) {
                            c = this.children();
                            k = 0;
                            for (p = c.length; k < p; k++) e = c[k], b(e).removeAttr("disabled");
                            if (isNaN(l))
                                for (r = r.toLowerCase(), d = s = 0, q = this.children().length; 0 <= q ? s < q : s > q; d = 0 <= q ? ++s : --s) this.child(d).text().toLowerCase() === r && (this.uiData().selected = d, this.child(d).attr("disabled", !0));
                    ...
                    return this.each(function () {
                        ...
                        return b(this).on("keypress", function (f) {
                            try {
                                ...
                                return error("onEnterKeypress.keypress", e)
                            }
                        })
                    })
                };
                    ...
                    return this.each(function () {
                        ...
                        return b(this).on("keypress", function (f) {
                            try {
                                ...
                                return error("onEscapeKeypress.keypress", e)
                            }
                        })
                    })
                };
                ...
                b.fn.addChildClass = function (a) {
                    ...
                    try {
                        ...
                        throw Error("addChildClass(" + a + ") -> " + e.message);
                    }
                };
                ...
                b.fn.moveClassesFrom = function (a) {
                    var b, e, g, d;
                    e = a[0].className.split(" ");
                    for (g = 0; g < e.length;) {
                        b = !0;
                        for (d = 1; d < arguments.length;) arguments[d] === e[g] && (b = !1), d++;
                        b && (this.addClass(e[g]), a.removeClass(e[g]));
                        g++
                    }
                    return this
                };
                b.fn.draw = function (a, d) {
                    try {
                        ...
                        !b.mobile || ("boolean" === typeof d && !0 !== d || "function" !== typeof this.enhanceWithin) || this.enhanceWithin()
                    } catch (e) {
                        throw Error("$.draw(" + a + ") -> " + e.message);
                    }
                    return this
                };
                return b.fn.popup = function (a) {
                    try {
                        return this.each(function () {
                            var e;
                            e = b(this);
                            if ("open" === a) return e.addClass("show"), b("#popupbehind").addClass("show");
                            if ("close" === a) return b("#popupbehind").removeClass("show"), e.removeClass("show")
                        })
                    } catch (d) {
                        throw Error("$.popup(" +
                            a + ") -> " + d);
            ...
            window.error || (window.error = function (b, a, d) {
                null != a && (b += " " + a);
                "undefined" !== typeof errorMesssage && null !== errorMesssage && (b += " " + d);
            ...
            return function (b) {
                ...
                f = function (a, b, e) {
                    ...
                    d.uiData().node = d;
                    d.uiData().type = a;
                    "object" === typeof e && (d.uiData().elementMap = e);
                ...
                e = function (a, b, e, d) {
                    ...
                    f.uiData().type = b;
                    f.uiData().node = f;
                    "object" === typeof d && (f.uiData().elementMap = d);
                    null != e && ("object" === typeof e && e.length) && f.addChildren(e);
                    return f
                };
                b.body = function () {
                    null == a && (a = $("body"));
                ...
                b.page = function () {
                    return e("page", "div", x(arguments)).dataRole("page").addClass("page")
                };
                ...
                b.ui = function (a) {
                    ...
                    try {
                        ...
                        d = arguments[0];
                        if ("string" !== typeof d || null == d || 0 === d.length) return "";
                        d.startsWith("%") && (d = d.substring(1), d.endsWith("%") && (d = d.substring(0, d.length - 1)));
                        if ("undefined" === typeof UI || "undefined" === typeof UI[settings.interfacelanguage] || "undefined" === typeof UI[settings.interfacelanguage][d]) return d;
                        a = UI[settings.interfacelanguage][d];
                        if (1 < arguments.length)
                            for (b = 1; b < arguments.length;) e = a.indexOf("$" + b), 0 <= e && (a = a.substring(0, e) + arguments[b] + a.substring(e + ("$" + b).length)), b++;
                        return a
                    } catch (f) {
                        return error("ui(" + d + ")", f.message), ""
                    }
                };
    ...
    $(document).ready(function () {
        var w;
        try {
            console.log("introtoapps v.20170401.1");
            d.init();
